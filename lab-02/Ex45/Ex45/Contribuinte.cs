...
namespace Ex45
{
    class Contribuinte
    {
        ...
        public Contribuinte(String nome, String endereco, bool pfisica) // construtor para instânciar contribuinte válido
        {
            Nome = nome;
            Endereco = endereco;
            PFisica = pfisica;
        ...
        public virtual double CalcImposto() // método que será sobreescrito para calcular e retornar valor do imposto
        {
            return 0;
        }

        public virtual string MostrarInformacoes() // método para exibir informações do contribuinte que será sobreescrito
        {
            return "";
        }
    }
