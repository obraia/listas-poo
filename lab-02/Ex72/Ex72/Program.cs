                ...
                using (StreamReader sr = File.OpenText(arquivoContas))
                {
                    while (!sr.EndOfStream)
                    {
                        ...
                        var dados = linhas.Split(';'); // separar dados entre ';'
                                                       ...
                                                       // 1. Titular 2. Num conta 3. Tipo 4. Agência 5. Saldo 6. Data de criação 
                                                       // 7. Status da conta (estar ou não ativa)
                        try
                        {
                            ...
                            DateTime data = Convert.ToDateTime(dados[5]); // convertendo e armazenando data de criação da conta
