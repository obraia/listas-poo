...
namespace Ex72
{
    class Investimento : Conta
    {
        ...
        public Investimento(float rendimento, float imposto, string titular, int numConta, int tipoConta, int agencia, double saldo, DateTime data, bool contaStatus) : base (titular, numConta, tipoConta, agencia, saldo, data, contaStatus)
        {
