namespace Ex72
{
    class Poupanca : Conta
    {
        ...
        public Poupanca(float taxaJuros, string titular, int numConta, int tipoConta, int agencia, double saldo, string data, bool contaStatus) : base(titular, numConta, tipoConta, agencia, saldo, data, contaStatus)
        {
            TaxaJuros = taxaJuros;
            RendimentoFinal();
        }
