...
{
    class Outros : IProduto, IComparable<IProduto>
    {
        public double Imposto { get => 0.35; }
        ...
        public Outros(string id, string nome, double preco, int quantidade, int quantidadeVendida, DateTime dataCadastro, string descricao)
        {
            ID = id;
            Categoria = "Outros";
            Nome = nome;
